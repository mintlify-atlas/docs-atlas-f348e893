---
title: "TypeScript API Reference: define* Helpers and Runtime Context"
sidebarTitle: "TypeScript API"
description: "Complete reference for every define* helper, runtime ctx members, and import paths in the eve TypeScript public API."
---

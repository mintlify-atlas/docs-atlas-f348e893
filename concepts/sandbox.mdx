...
description: "Every eve agent has an isolated /workspace sandbox with built-in bash and file tools, ctx.getSandbox() for programmatic access, and defineSandbox to customize it."
---
